...
def get_user_information(request):
    if request.method == "POST" and request.is_ajax():
        ...
        if user.personalinformation.facebook is None and user.personalinformation.github is None and user.personalinformation.twitter is None and user.personalinformation.insta is None:
